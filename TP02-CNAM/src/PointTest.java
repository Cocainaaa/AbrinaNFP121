...
public class PointTest {
	...
	public void testInitialisationMieux() {
		...
		assertNotEquals(1.0, p2.getX(), EPSILON); // Erreur n1 : l'abscisse du deuxièeme point n'est pas égal à 1
		assertNotEquals(2.0, p2.getY(), EPSILON); // Erreur n2  L'ordonnée du deuxièeme point n'est pas égal à 2
	}
	...
	public void testSetCouleur() {
		...
		p2.setCouleur(Color.orange);
		assertNotEquals(p1.getCouleur(),Color.green);
		assertNotEquals(p2.getCouleur(),Color.pink);
		assertEquals(p1.getCouleur(),Color.red);
		assertEquals(p2.getCouleur(),Color.orange);
	}
