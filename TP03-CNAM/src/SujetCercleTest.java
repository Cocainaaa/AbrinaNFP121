...
/**
  * Classe de test (incompl̬te) de la classe Cercle.
...
public class SujetCercleTest {
	...
	/** V̩rifier si deux points ont m̻mes coordonn̩es.
	  * @param p1 le premier point
	  * @param p2 le deuxi̬me point
	  */
	...
	@Test public void testerE5() {
		...
		assertFalse("E5", new Cercle(D, 3).contient(E));
	}
	...
	@Test public void testerToString() {
		assertEquals("E15: toString() red̩finie ? Correctement ?",
